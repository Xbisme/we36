...
- **Follow-ups**: T061 changelog finalize at merge; on-device gallery-permission → #015 gate; repo-wide golden refresh needed after the Flutter 3.44.4 upgrade (pre-existing #001/#003/#004 goldens mismatch the new engine); `bloc_tools:bloc lint` not runnable locally (`bloc_lint 0.4.1` ships no CLI).
