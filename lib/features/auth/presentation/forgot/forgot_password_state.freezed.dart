...
mixin _$ForgotPasswordState {
 ...
 ForgotStep get step; String get email; bool get submitting; int get resendCooldown; AppFailure? get error; String? get devCode;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ForgotPasswordState&&(identical(other.step, step) || other.step == step)&&(identical(other.email, email) || other.email == email)&&(identical(other.submitting, submitting) || other.submitting == submitting)&&(identical(other.resendCooldown, resendCooldown) || other.resendCooldown == resendCooldown)&&(identical(other.error, error) || other.error == error)&&(identical(other.devCode, devCode) || other.devCode == devCode));
}


@override
int get hashCode => Object.hash(runtimeType,step,email,submitting,resendCooldown,error,devCode);

@override
String toString() {
  return 'ForgotPasswordState(step: $step, email: $email, submitting: $submitting, resendCooldown: $resendCooldown, error: $error, devCode: $devCode)';
}
...
@useResult
$Res call({
 ForgotStep step, String email, bool submitting, int resendCooldown, AppFailure? error, String? devCode
});
...
/// Create a copy of ForgotPasswordState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? step = null,Object? email = null,Object? submitting = null,Object? resendCooldown = null,Object? error = freezed,Object? devCode = freezed,}) {
  return _then(_self.copyWith(
step: null == step ? _self.step : step // ignore: cast_nullable_to_non_nullable
as ForgotStep,email: null == email ? _self.email : email // ignore: cast_nullable_to_non_nullable
as String,submitting: null == submitting ? _self.submitting : submitting // ignore: cast_nullable_to_non_nullable
as bool,resendCooldown: null == resendCooldown ? _self.resendCooldown : resendCooldown // ignore: cast_nullable_to_non_nullable
as int,error: freezed == error ? _self.error : error // ignore: cast_nullable_to_non_nullable
as AppFailure?,devCode: freezed == devCode ? _self.devCode : devCode // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
/// Create a copy of ForgotPasswordState
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ForgotStep step,  String email,  bool submitting,  int resendCooldown,  AppFailure? error,  String? devCode)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ForgotPasswordState() when $default != null:
return $default(_that.step,_that.email,_that.submitting,_that.resendCooldown,_that.error,_that.devCode);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ForgotStep step,  String email,  bool submitting,  int resendCooldown,  AppFailure? error,  String? devCode)  $default,) {final _that = this;
switch (_that) {
case _ForgotPasswordState():
return $default(_that.step,_that.email,_that.submitting,_that.resendCooldown,_that.error,_that.devCode);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ForgotStep step,  String email,  bool submitting,  int resendCooldown,  AppFailure? error,  String? devCode)?  $default,) {final _that = this;
switch (_that) {
case _ForgotPasswordState() when $default != null:
return $default(_that.step,_that.email,_that.submitting,_that.resendCooldown,_that.error,_that.devCode);case _:
  return null;
...
class _ForgotPasswordState implements ForgotPasswordState {
  const _ForgotPasswordState({this.step = ForgotStep.email, this.email = '', this.submitting = false, this.resendCooldown = 0, this.error, this.devCode});
  

@override@JsonKey() final  ForgotStep step;
@override@JsonKey() final  String email;
@override@JsonKey() final  bool submitting;
@override@JsonKey() final  int resendCooldown;
@override final  AppFailure? error;
@override final  String? devCode;
...
/// Create a copy of ForgotPasswordState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? step = null,Object? email = null,Object? submitting = null,Object? resendCooldown = null,Object? error = freezed,Object? devCode = freezed,}) {
