...
mixin _$MeProfile {
 ...
 String get id; String get email; bool get isPrivate; bool get isVerified; bool get profileCompleted; DateTime get createdAt; String? get username; String? get displayName; String? get avatarMediaId; String? get bio; String? get website; String? get pronouns;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,email,isPrivate,isVerified,profileCompleted,createdAt,username,displayName,avatarMediaId,bio,website,pronouns);

@override
String toString() {
  return 'MeProfile(id: $id, email: $email, isPrivate: $isPrivate, isVerified: $isVerified, profileCompleted: $profileCompleted, createdAt: $createdAt, username: $username, displayName: $displayName, avatarMediaId: $avatarMediaId, bio: $bio, website: $website, pronouns: $pronouns)';
}
...
@useResult
$Res call({
 String id, String email, bool isPrivate, bool isVerified, bool profileCompleted, DateTime createdAt, String? username, String? displayName, String? avatarMediaId, String? bio, String? website, String? pronouns
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String email,  bool isPrivate,  bool isVerified,  bool profileCompleted,  DateTime createdAt,  String? username,  String? displayName,  String? avatarMediaId,  String? bio,  String? website,  String? pronouns)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MeProfile() when $default != null:
return $default(_that.id,_that.email,_that.isPrivate,_that.isVerified,_that.profileCompleted,_that.createdAt,_that.username,_that.displayName,_that.avatarMediaId,_that.bio,_that.website,_that.pronouns);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String email,  bool isPrivate,  bool isVerified,  bool profileCompleted,  DateTime createdAt,  String? username,  String? displayName,  String? avatarMediaId,  String? bio,  String? website,  String? pronouns)  $default,) {final _that = this;
switch (_that) {
case _MeProfile():
return $default(_that.id,_that.email,_that.isPrivate,_that.isVerified,_that.profileCompleted,_that.createdAt,_that.username,_that.displayName,_that.avatarMediaId,_that.bio,_that.website,_that.pronouns);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String email,  bool isPrivate,  bool isVerified,  bool profileCompleted,  DateTime createdAt,  String? username,  String? displayName,  String? avatarMediaId,  String? bio,  String? website,  String? pronouns)?  $default,) {final _that = this;
switch (_that) {
case _MeProfile() when $default != null:
return $default(_that.id,_that.email,_that.isPrivate,_that.isVerified,_that.profileCompleted,_that.createdAt,_that.username,_that.displayName,_that.avatarMediaId,_that.bio,_that.website,_that.pronouns);case _:
  return null;
...
class _MeProfile implements MeProfile {
  const _MeProfile({required this.id, required this.email, required this.isPrivate, required this.isVerified, required this.profileCompleted, required this.createdAt, this.username, this.displayName, this.avatarMediaId, this.bio, this.website, this.pronouns});
